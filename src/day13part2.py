...
happiness_changes['me'] = {}
for invitee in happiness_changes.keys():
    happiness_changes['me'][invitee] = 0
    happiness_changes[invitee]['me'] = 0
...
print('Part 2 ans: {}'.format(max(net_happinesses)))
